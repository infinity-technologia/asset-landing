    ...
    <div class="container-fluid">
        <div class="my-17">
            <div class="container">
                ...
                <div class="row py-5">
                    <div class="col">
                        <iframe style="border:0; width: 100%; height: 370px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.026337030271!2d106.79387927578139!3d-6.260261061291903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x66517b8cb4180971%3A0xc27bbf2d71f5030b!2sizidok!5e0!3m2!1sid!2sid!4v1697611425066!5m2!1sid!2sid" allowfullscreen referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <div class="row py-5">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        <form method="post" action="#" role="form" class="contact-form" id="contact-form">
                            ...
                            <div class="row gy-2 gx-md-3">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    <input type="text" class="form-control number" name="phone" id="phone" placeholder="Nomor HP" required>
                                </div>
                                <div class="col-md-6 form-group mb-3">
                                ...
                                <div class="col-md-12 form-group mb-3">
                                    <input type="text" class="form-control" name="profesi" id="profesi" placeholder="Profesi. Contoh: Dokter, Perawat, Admin, dsb" required>
                                </div>
