            ...
            <div class="row pb-10 pb-lg-20">
                <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                    <div class="mb-5 text-center text-sm-start">
                        <img class="img-fluid" src="{{ asset('images/logos/logo_izidok-white.png') }}"
                            alt="logo izidok white">
                    </div>
                    <div class="mb-5">
                        <p class="fs-5 text-white mb-3">Aplikasi website dengan fitur yang lengkap untuk membantu
                            operasional Dokter Praktik Mandiri dan Klinik.</p>
                    </div>
                    <div class="mb-5">
                        <p class="fs-5 text-white mb-3">{!! $app['address'] !!}</p>
                    </div>
                </div>
                <div class="col-lg-6 ps-lg-16">
                    <div class="d-flex justify-content-between">
                        <div class="d-flex fw-semibold flex-column me-20">
                            ...
                            <a href="#" class="text-white fs-5 mb-6" data-kt-scroll-toggle="true"
                            ...
                            <a href="#about" class="text-white fs-5 mb-6" data-kt-scroll-toggle="true"
                                data-kt-drawer-dismiss="true">
                                <svg width="15" height="11" viewBox="0 0 15 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="#pricing" class="text-white fs-5 mb-6" data-kt-scroll-toggle="true"
                                data-kt-drawer-dismiss="true">
                                <svg width="15" height="11" viewBox="0 0 15 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="#maps" class="text-white fs-5 mb-6" data-kt-scroll-toggle="true"
                                data-kt-drawer-dismiss="true">
                                <svg width="15" height="11" viewBox="0 0 15 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="#contact" class="text-white fs-5 mb-6" data-kt-scroll-toggle="true"
                                data-kt-drawer-dismiss="true">
                                <svg width="15" height="11" viewBox="0 0 15 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row flex-stack py-5">
                <div class="d-flex align-items-center order-2 order-md-1">
                    <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1">&copy; 2023 izidok. All rights
                        reserved.</span>
                </div>
            </div>
        </div>
