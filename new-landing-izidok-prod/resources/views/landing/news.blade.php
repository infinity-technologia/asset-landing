    ...
    <div class="container-fluid">
        <div class="my-17">
            ...
            <div class="tns tns-default">
                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="5000" data-tns-controls="true" data-tns-nav="true" data-tns-nav-position="bottom" data-tns-items="3" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_news_slider_prev1" data-tns-next-button="#kt_news_slider_next1">
                    <div class="card-xl-stretch mx-3">
                        ...
                        <div class="py-5 px-4 text-start text-md-justify rounded-bottom">
                            <a href="{{ route('news-update-detail','izidok-siap-menjadi-pionir-ekosistem-kesehatan-digital-di-indonesia') }}" class="text-gray-800 fw-bold text-hover-primary text-dark lh-base">Menyambut 2024, izidok Siap Menjadi Pionir Ekosistem Kesehatan Digital di Indonesia</a>
                        </div>
                    </div>
                    <div class="card-xl-stretch mx-3">
